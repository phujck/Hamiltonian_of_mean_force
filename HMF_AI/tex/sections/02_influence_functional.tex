...
To proceed directly from the introduction, we make explicit the composite model.
...
$\xi$-histories chosen such that Eq.~\eqref{eq:noise_characteristic_functional} holds.
