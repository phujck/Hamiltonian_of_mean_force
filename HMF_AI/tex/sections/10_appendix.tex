...
\end{equation}
This series matches Eq.~\eqref{eq:app_lhs_expanded} term-by-term, proving the exponentiation of the Gaussian average. Consequently, we may write the influence on the reduced density matrix as
\begin{equation}
    \begin{split}
