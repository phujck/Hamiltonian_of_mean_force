...
- `omega_q`: 3.0
- `theta`: 0.25
- `lambda_range`: [0.0, 2.0] with 201 points
- `n_modes`: 2, `n_cut`: 4
- `v4_lambda_map`: lam2
...
- Sym model endpoint trace distance: `0.073680`
...
- Sym field MAE (hx, hy, hz): `(4.4171, 0.0000, 11.7750)`
- Ordered field MAE (hx, hy, hz): `(0.0260, 0.0000, 0.0058)`
...
## Reference Plots
![Alignment](../figures/prl127_scaling_probe_alignment.png)

![Diagnostics](../figures/prl127_scaling_probe_diagnostics.png)

![Field Components](../figures/prl127_scaling_probe_fields.png)

## Data Files
- Scan CSV: `C:\Users\gerar\VScodeProjects\Hamiltonian_of_mean_force\simulations\results\data\prl127_scaling_probe_scan.csv`
- Summary CSV: `C:\Users\gerar\VScodeProjects\Hamiltonian_of_mean_force\simulations\results\data\prl127_scaling_probe_summary.csv`
