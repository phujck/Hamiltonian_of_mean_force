...
- Sym non-Hermiticity max: `2.220e-16`
- Eq67 non-Hermiticity max: `7.165e-01`
- Sym field MAE (hx, hy, hz): `(5.0733, 0.0000, 13.7250)`
...
## Reference Plots
![Alignment](../figures/prl127_bridge_lam_alignment.png)

![Diagnostics](../figures/prl127_bridge_lam_diagnostics.png)

![Field Components](../figures/prl127_bridge_lam_fields.png)

## Data Files
- Scan CSV: `C:\Users\gerar\VScodeProjects\Hamiltonian_of_mean_force\simulations\results\data\prl127_bridge_lam_scan.csv`
- Summary CSV: `C:\Users\gerar\VScodeProjects\Hamiltonian_of_mean_force\simulations\results\data\prl127_bridge_lam_summary.csv`
