...
against exact finite-bath trace-out calculations over the full coupling range, using
Sec.~\ref{sec:qubit_prl_recovery} as the analytic target: the direct-kernel Gaussian
weak target in Eqs.~\eqref{eq:rho_weak_prl}--\eqref{eq:delta_rho_weak_prl} and the
ultrastrong projector state in Eq.~\eqref{eq:rho_us_qubit_prl}.
